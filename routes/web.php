...
<<<<<<< HEAD
    ...
    Route::post('/reports/save',[ReportController::class, 'store']);
    Route::get('/reports/{id}/delete',[ReportController::class, 'destroy']);
    Route::post('/reports/{id}/update',[ReportController::class, 'update']);
    Route::get('/reports/{id}/edit',[ReportController::class, 'show']);
    //presentation
...
=======
    ...
    Route::post('/risk/{id}/update',[RiskController::class, 'update']);
    Route::get('/risk/{id}/delete',[RiskController::class, 'destroy']);
    Route::get('/risk/{id}/edit', [RiskController::class, 'edit']);
>>>>>>> 1992e0e52e48761aef8d4c681f20198965ac2e69
