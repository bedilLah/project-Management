    ...
    <div class="bg-secondary rounded h-100 p-4">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input type="text" name="bussines_line" id="" class="form-control mb-3 text-white" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="status" id="" class="form-control mb-3 text-white" required>
            </div>
        </div>   
        <div class="row mb-3"> 
            <div class="col-md-4">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <label for="" class="form-label text-white">Contract Duration</label>
