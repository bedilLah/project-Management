    ...
    <div class="bg-secondary rounded h-100 p-3">
        ...
        <form action="/user/{{ $user->id }}/update" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="" value="{{$user->name}}" class="form-control text-white" placeholder="name" required>
            </div>
            <div class="mb-3">
                <label for="" class="form-label text-white">Username</label>
                <input type="text" name="username" id="" value="{{$user->username}}" class="form-control text-white" placeholder="username" required>
            </div>
            <div class="mb-3">
            ...
            <a href="/user/index" class="btn btn-sm btn-outline-danger m-2">Cancel</a>
        </form>
    </div>
</div>
